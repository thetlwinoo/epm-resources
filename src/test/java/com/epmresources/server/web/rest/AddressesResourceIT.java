...
import com.epmresources.server.repository.AddressesRepository;
import com.epmresources.server.service.AddressesService;
import com.epmresources.server.service.dto.AddressesDTO;
import com.epmresources.server.service.mapper.AddressesMapper;
import com.epmresources.server.web.rest.errors.ExceptionTranslator;
import com.epmresources.server.service.dto.AddressesCriteria;
import com.epmresources.server.service.AddressesQueryService;
...
public class AddressesResourceIT {
    ...
    private static final String DEFAULT_CONTACT_EMAIL_ADDRESS = "#a@kh.m";
    private static final String UPDATED_CONTACT_EMAIL_ADDRESS = "|W@Kq.X";

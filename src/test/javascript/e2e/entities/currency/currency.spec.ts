...
describe('Currency e2e test', () => {
  ...
  it('should load Currencies', async () => {
    ...
    expect(await currencyComponentsPage.getTitle()).to.eq('epmresourcesApp.currency.home.title');
  });
  ...
  it('should load create Currency page', async () => {
    ...
    expect(await currencyUpdatePage.getPageTitle()).to.eq('epmresourcesApp.currency.home.createOrEditLabel');
  ...
  it('should delete last Currency', async () => {
    ...
    expect(await currencyDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.currency.delete.question');

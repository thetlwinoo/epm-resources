...
export class StockItemsUpdatePage {
  ...
  async stockItemOnReviewLineSelectLastOption(timeout?: number) {
  ...
  async itemLengthUnitSelectLastOption(timeout?: number) {
  ...
  async itemWidthUnitSelectLastOption(timeout?: number) {
  ...
  async itemHeightUnitSelectLastOption(timeout?: number) {
  ...
  async packageLengthUnitSelectLastOption(timeout?: number) {
  ...
  async packageWidthUnitSelectLastOption(timeout?: number) {
  ...
  async packageHeightUnitSelectLastOption(timeout?: number) {
  ...
  async itemPackageWeightUnitSelectLastOption(timeout?: number) {
  ...
  async productAttributeSelectLastOption(timeout?: number) {
  ...
  async productOptionSelectLastOption(timeout?: number) {
  ...
  async materialSelectLastOption(timeout?: number) {
  ...
  async currencySelectLastOption(timeout?: number) {
  ...
  async barcodeTypeSelectLastOption(timeout?: number) {

...
describe('StockItems e2e test', () => {
  ...
  it('should load StockItems', async () => {
    ...
    expect(await stockItemsComponentsPage.getTitle()).to.eq('epmresourcesApp.stockItems.home.title');
  });
  ...
  it('should load create StockItems page', async () => {
    ...
    expect(await stockItemsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.stockItems.home.createOrEditLabel');
  ...
  it('should delete last StockItems', async () => {
    ...
    expect(await stockItemsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.stockItems.delete.question');

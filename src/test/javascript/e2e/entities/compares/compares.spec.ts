...
describe('Compares e2e test', () => {
  ...
  it('should load Compares', async () => {
    ...
    expect(await comparesComponentsPage.getTitle()).to.eq('epmresourcesApp.compares.home.title');
  });
  ...
  it('should load create Compares page', async () => {
    ...
    expect(await comparesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.compares.home.createOrEditLabel');
  ...
  it('should delete last Compares', async () => {
    ...
    expect(await comparesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.compares.delete.question');

...
describe('ShoppingCarts e2e test', () => {
  ...
  it('should load ShoppingCarts', async () => {
    ...
    expect(await shoppingCartsComponentsPage.getTitle()).to.eq('epmresourcesApp.shoppingCarts.home.title');
  });
  ...
  it('should load create ShoppingCarts page', async () => {
    ...
    expect(await shoppingCartsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.shoppingCarts.home.createOrEditLabel');
  ...
  it('should delete last ShoppingCarts', async () => {
    ...
    expect(await shoppingCartsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.shoppingCarts.delete.question');

...
describe('ProductAttributeSet e2e test', () => {
  ...
  it('should load ProductAttributeSets', async () => {
    ...
    expect(await productAttributeSetComponentsPage.getTitle()).to.eq('epmresourcesApp.productAttributeSet.home.title');
  });
  ...
  it('should load create ProductAttributeSet page', async () => {
    ...
    expect(await productAttributeSetUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productAttributeSet.home.createOrEditLabel');
  ...
  it('should delete last ProductAttributeSet', async () => {
    ...
    expect(await productAttributeSetDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productAttributeSet.delete.question');

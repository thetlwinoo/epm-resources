...
export class InvoicesUpdatePage {
  ...
  async salespersonPersonSelectLastOption(timeout?: number) {
  ...
  async packedByPersonSelectLastOption(timeout?: number) {
  ...
  async accountsPersonSelectLastOption(timeout?: number) {
  ...
  async billToCustomerSelectLastOption(timeout?: number) {
  ...
  async deliveryMethodSelectLastOption(timeout?: number) {

...
describe('PurchaseOrders e2e test', () => {
  ...
  it('should load PurchaseOrders', async () => {
    ...
    expect(await purchaseOrdersComponentsPage.getTitle()).to.eq('epmresourcesApp.purchaseOrders.home.title');
  });
  ...
  it('should load create PurchaseOrders page', async () => {
    ...
    expect(await purchaseOrdersUpdatePage.getPageTitle()).to.eq('epmresourcesApp.purchaseOrders.home.createOrEditLabel');
  ...
  it('should delete last PurchaseOrders', async () => {
    ...
    expect(await purchaseOrdersDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.purchaseOrders.delete.question');

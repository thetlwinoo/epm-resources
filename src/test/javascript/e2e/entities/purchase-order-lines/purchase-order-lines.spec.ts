...
describe('PurchaseOrderLines e2e test', () => {
  ...
  it('should load PurchaseOrderLines', async () => {
    ...
    expect(await purchaseOrderLinesComponentsPage.getTitle()).to.eq('epmresourcesApp.purchaseOrderLines.home.title');
  });
  ...
  it('should load create PurchaseOrderLines page', async () => {
    ...
    expect(await purchaseOrderLinesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.purchaseOrderLines.home.createOrEditLabel');
  ...
  it('should delete last PurchaseOrderLines', async () => {
    ...
    expect(await purchaseOrderLinesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.purchaseOrderLines.delete.question');

...
describe('UploadActionTypes e2e test', () => {
  ...
  it('should load UploadActionTypes', async () => {
    ...
    expect(await uploadActionTypesComponentsPage.getTitle()).to.eq('epmresourcesApp.uploadActionTypes.home.title');
  });
  ...
  it('should load create UploadActionTypes page', async () => {
    ...
    expect(await uploadActionTypesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.uploadActionTypes.home.createOrEditLabel');
  ...
  it('should delete last UploadActionTypes', async () => {
    ...
    expect(await uploadActionTypesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.uploadActionTypes.delete.question');

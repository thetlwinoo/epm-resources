...
describe('ShoppingCartItems e2e test', () => {
  ...
  it('should load ShoppingCartItems', async () => {
    ...
    expect(await shoppingCartItemsComponentsPage.getTitle()).to.eq('epmresourcesApp.shoppingCartItems.home.title');
  });
  ...
  it('should load create ShoppingCartItems page', async () => {
    ...
    expect(await shoppingCartItemsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.shoppingCartItems.home.createOrEditLabel');
  ...
  it('should delete last ShoppingCartItems', async () => {
    ...
    expect(await shoppingCartItemsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.shoppingCartItems.delete.question');

...
describe('StockItemHoldings e2e test', () => {
  ...
  it('should load StockItemHoldings', async () => {
    ...
    expect(await stockItemHoldingsComponentsPage.getTitle()).to.eq('epmresourcesApp.stockItemHoldings.home.title');
  });
  ...
  it('should load create StockItemHoldings page', async () => {
    ...
    expect(await stockItemHoldingsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.stockItemHoldings.home.createOrEditLabel');
  ...
  it('should delete last StockItemHoldings', async () => {
    ...
    expect(await stockItemHoldingsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.stockItemHoldings.delete.question');

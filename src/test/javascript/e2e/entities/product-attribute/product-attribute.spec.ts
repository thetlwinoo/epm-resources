...
describe('ProductAttribute e2e test', () => {
  ...
  it('should load ProductAttributes', async () => {
    ...
    expect(await productAttributeComponentsPage.getTitle()).to.eq('epmresourcesApp.productAttribute.home.title');
  });
  ...
  it('should load create ProductAttribute page', async () => {
    ...
    expect(await productAttributeUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productAttribute.home.createOrEditLabel');
  ...
  it('should create and save ProductAttributes', async () => {
    ...
    expect(await productAttributeUpdatePage.getProductAttributeValueInput()).to.eq(
  ...
  it('should delete last ProductAttribute', async () => {
    ...
    expect(await productAttributeDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productAttribute.delete.question');

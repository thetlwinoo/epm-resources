...
describe('UploadTransactions e2e test', () => {
  ...
  it('should load UploadTransactions', async () => {
    ...
    expect(await uploadTransactionsComponentsPage.getTitle()).to.eq('epmresourcesApp.uploadTransactions.home.title');
  });
  ...
  it('should load create UploadTransactions page', async () => {
    ...
    expect(await uploadTransactionsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.uploadTransactions.home.createOrEditLabel');
  ...
  it('should delete last UploadTransactions', async () => {
    ...
    expect(await uploadTransactionsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.uploadTransactions.delete.question');

...
describe('PersonPhone e2e test', () => {
  ...
  it('should load PersonPhones', async () => {
    ...
    expect(await personPhoneComponentsPage.getTitle()).to.eq('epmresourcesApp.personPhone.home.title');
  });
  ...
  it('should load create PersonPhone page', async () => {
    ...
    expect(await personPhoneUpdatePage.getPageTitle()).to.eq('epmresourcesApp.personPhone.home.createOrEditLabel');
  ...
  it('should delete last PersonPhone', async () => {
    ...
    expect(await personPhoneDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.personPhone.delete.question');

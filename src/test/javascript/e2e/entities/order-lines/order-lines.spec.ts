...
describe('OrderLines e2e test', () => {
  ...
  it('should load OrderLines', async () => {
    ...
    expect(await orderLinesComponentsPage.getTitle()).to.eq('epmresourcesApp.orderLines.home.title');
  });
  ...
  it('should load create OrderLines page', async () => {
    ...
    expect(await orderLinesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.orderLines.home.createOrEditLabel');
  ...
  it('should delete last OrderLines', async () => {
    ...
    expect(await orderLinesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.orderLines.delete.question');

...
describe('ProductCatalog e2e test', () => {
  ...
  it('should load ProductCatalogs', async () => {
    ...
    expect(await productCatalogComponentsPage.getTitle()).to.eq('epmresourcesApp.productCatalog.home.title');
  });
  ...
  it('should load create ProductCatalog page', async () => {
    ...
    expect(await productCatalogUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productCatalog.home.createOrEditLabel');
  ...
  it('should delete last ProductCatalog', async () => {
    ...
    expect(await productCatalogDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productCatalog.delete.question');

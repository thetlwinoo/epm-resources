...
describe('ProductSet e2e test', () => {
  ...
  it('should load ProductSets', async () => {
    ...
    expect(await productSetComponentsPage.getTitle()).to.eq('epmresourcesApp.productSet.home.title');
  });
  ...
  it('should load create ProductSet page', async () => {
    ...
    expect(await productSetUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productSet.home.createOrEditLabel');
  ...
  it('should create and save ProductSets', async () => {
    ...
    expect(await productSetUpdatePage.getProductSetNameInput()).to.eq(
      'productSetName',
      'Expected ProductSetName value to be equals to productSetName'
    );
  ...
  it('should delete last ProductSet', async () => {
    ...
    expect(await productSetDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productSet.delete.question');

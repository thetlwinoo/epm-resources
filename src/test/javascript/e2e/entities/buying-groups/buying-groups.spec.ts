...
describe('BuyingGroups e2e test', () => {
  ...
  it('should load BuyingGroups', async () => {
    ...
    expect(await buyingGroupsComponentsPage.getTitle()).to.eq('epmresourcesApp.buyingGroups.home.title');
  });
  ...
  it('should load create BuyingGroups page', async () => {
    ...
    expect(await buyingGroupsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.buyingGroups.home.createOrEditLabel');
  ...
  it('should delete last BuyingGroups', async () => {
    ...
    expect(await buyingGroupsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.buyingGroups.delete.question');

...
export class OrdersUpdatePage {
  ...
  async orderOnReviewSelectLastOption(timeout?: number) {
  ...
  async shipToAddressSelectLastOption(timeout?: number) {
  ...
  async billToAddressSelectLastOption(timeout?: number) {
  ...
  async shipMethodSelectLastOption(timeout?: number) {
  ...
  async currencyRateSelectLastOption(timeout?: number) {
  ...
  async specialDealsSelectLastOption(timeout?: number) {

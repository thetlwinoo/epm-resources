...
describe('Orders e2e test', () => {
  ...
  it('should load Orders', async () => {
    ...
    expect(await ordersComponentsPage.getTitle()).to.eq('epmresourcesApp.orders.home.title');
  });
  ...
  it('should load create Orders page', async () => {
    ...
    expect(await ordersUpdatePage.getPageTitle()).to.eq('epmresourcesApp.orders.home.createOrEditLabel');
  ...
  it('should delete last Orders', async () => {
    ...
    expect(await ordersDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.orders.delete.question');

...
describe('Wishlists e2e test', () => {
  ...
  it('should load Wishlists', async () => {
    ...
    expect(await wishlistsComponentsPage.getTitle()).to.eq('epmresourcesApp.wishlists.home.title');
  });
  ...
  it('should load create Wishlists page', async () => {
    ...
    expect(await wishlistsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.wishlists.home.createOrEditLabel');
  ...
  it('should delete last Wishlists', async () => {
    ...
    expect(await wishlistsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.wishlists.delete.question');

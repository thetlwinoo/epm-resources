...
describe('CustomerCategories e2e test', () => {
  ...
  it('should load CustomerCategories', async () => {
    ...
    expect(await customerCategoriesComponentsPage.getTitle()).to.eq('epmresourcesApp.customerCategories.home.title');
  });
  ...
  it('should load create CustomerCategories page', async () => {
    ...
    expect(await customerCategoriesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.customerCategories.home.createOrEditLabel');
  ...
  it('should delete last CustomerCategories', async () => {
    ...
    expect(await customerCategoriesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.customerCategories.delete.question');

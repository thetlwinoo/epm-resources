...
describe('ReviewLines e2e test', () => {
  ...
  it('should load ReviewLines', async () => {
    ...
    expect(await reviewLinesComponentsPage.getTitle()).to.eq('epmresourcesApp.reviewLines.home.title');
  });
  ...
  it('should load create ReviewLines page', async () => {
    ...
    expect(await reviewLinesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.reviewLines.home.createOrEditLabel');
  ...
  it('should delete last ReviewLines', async () => {
    ...
    expect(await reviewLinesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.reviewLines.delete.question');

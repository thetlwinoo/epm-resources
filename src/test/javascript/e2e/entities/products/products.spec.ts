...
describe('Products e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productsComponentsPage.getTitle()).to.eq('epmresourcesApp.products.home.title');
  });
  ...
  it('should load create Products page', async () => {
    ...
    expect(await productsUpdatePage.getPageTitle()).to.eq('epmresourcesApp.products.home.createOrEditLabel');
  ...
  it('should delete last Products', async () => {
    ...
    expect(await productsDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.products.delete.question');

...
describe('InvoiceLines e2e test', () => {
  ...
  it('should load InvoiceLines', async () => {
    ...
    expect(await invoiceLinesComponentsPage.getTitle()).to.eq('epmresourcesApp.invoiceLines.home.title');
  });
  ...
  it('should load create InvoiceLines page', async () => {
    ...
    expect(await invoiceLinesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.invoiceLines.home.createOrEditLabel');
  ...
  it('should delete last InvoiceLines', async () => {
    ...
    expect(await invoiceLinesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.invoiceLines.delete.question');

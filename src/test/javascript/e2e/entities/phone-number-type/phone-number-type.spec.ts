...
describe('PhoneNumberType e2e test', () => {
  ...
  it('should load PhoneNumberTypes', async () => {
    ...
    expect(await phoneNumberTypeComponentsPage.getTitle()).to.eq('epmresourcesApp.phoneNumberType.home.title');
  });
  ...
  it('should load create PhoneNumberType page', async () => {
    ...
    expect(await phoneNumberTypeUpdatePage.getPageTitle()).to.eq('epmresourcesApp.phoneNumberType.home.createOrEditLabel');
  ...
  it('should delete last PhoneNumberType', async () => {
    ...
    expect(await phoneNumberTypeDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.phoneNumberType.delete.question');

...
describe('PackageTypes e2e test', () => {
  ...
  it('should load PackageTypes', async () => {
    ...
    expect(await packageTypesComponentsPage.getTitle()).to.eq('epmresourcesApp.packageTypes.home.title');
  });
  ...
  it('should load create PackageTypes page', async () => {
    ...
    expect(await packageTypesUpdatePage.getPageTitle()).to.eq('epmresourcesApp.packageTypes.home.createOrEditLabel');
  ...
  it('should delete last PackageTypes', async () => {
    ...
    expect(await packageTypesDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.packageTypes.delete.question');

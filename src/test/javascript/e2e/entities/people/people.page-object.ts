...
export class PeopleUpdatePage {
  ...
  getIsPermittedToLogonInput(timeout?: number) {
  ...
  getIsExternalLogonProviderInput(timeout?: number) {
    return this.isExternalLogonProviderInput;
  }
  getIsSystemUserInput(timeout?: number) {
    return this.isSystemUserInput;
  }
  getIsEmployeeInput(timeout?: number) {
    return this.isEmployeeInput;
  }
  getIsSalesPersonInput(timeout?: number) {
    return this.isSalesPersonInput;
  }
  getIsGuestUserInput(timeout?: number) {

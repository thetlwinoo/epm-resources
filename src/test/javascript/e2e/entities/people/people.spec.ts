...
describe('People e2e test', () => {
  ...
  it('should load People', async () => {
    ...
    expect(await peopleComponentsPage.getTitle()).to.eq('epmresourcesApp.people.home.title');
  });
  ...
  it('should load create People page', async () => {
    ...
    expect(await peopleUpdatePage.getPageTitle()).to.eq('epmresourcesApp.people.home.createOrEditLabel');
  ...
  /*  it('should delete last People', async () => {
        ...
        expect(await peopleDeleteDialog.getDialogTitle())
            .to.eq('epmresourcesApp.people.delete.question');

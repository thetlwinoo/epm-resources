...
describe('ProductDocument e2e test', () => {
  ...
  it('should load ProductDocuments', async () => {
    ...
    expect(await productDocumentComponentsPage.getTitle()).to.eq('epmresourcesApp.productDocument.home.title');
  });
  ...
  it('should load create ProductDocument page', async () => {
    ...
    expect(await productDocumentUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productDocument.home.createOrEditLabel');
  ...
  it('should delete last ProductDocument', async () => {
    ...
    expect(await productDocumentDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productDocument.delete.question');

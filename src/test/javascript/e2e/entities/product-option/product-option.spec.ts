...
describe('ProductOption e2e test', () => {
  ...
  it('should load ProductOptions', async () => {
    ...
    expect(await productOptionComponentsPage.getTitle()).to.eq('epmresourcesApp.productOption.home.title');
  });
  ...
  it('should load create ProductOption page', async () => {
    ...
    expect(await productOptionUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productOption.home.createOrEditLabel');
  ...
  it('should create and save ProductOptions', async () => {
    ...
    expect(await productOptionUpdatePage.getProductOptionValueInput()).to.eq(
      'productOptionValue',
  ...
  it('should delete last ProductOption', async () => {
    ...
    expect(await productOptionDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productOption.delete.question');

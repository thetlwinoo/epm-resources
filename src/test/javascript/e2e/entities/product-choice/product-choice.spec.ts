...
describe('ProductChoice e2e test', () => {
  ...
  it('should load ProductChoices', async () => {
    ...
    expect(await productChoiceComponentsPage.getTitle()).to.eq('epmresourcesApp.productChoice.home.title');
  });
  ...
  it('should load create ProductChoice page', async () => {
    ...
    expect(await productChoiceUpdatePage.getPageTitle()).to.eq('epmresourcesApp.productChoice.home.createOrEditLabel');
  ...
  it('should delete last ProductChoice', async () => {
    ...
    expect(await productChoiceDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.productChoice.delete.question');

...
describe('UnitMeasure e2e test', () => {
  ...
  it('should load UnitMeasures', async () => {
    ...
    expect(await unitMeasureComponentsPage.getTitle()).to.eq('epmresourcesApp.unitMeasure.home.title');
  });
  ...
  it('should load create UnitMeasure page', async () => {
    ...
    expect(await unitMeasureUpdatePage.getPageTitle()).to.eq('epmresourcesApp.unitMeasure.home.createOrEditLabel');
  ...
  it('should delete last UnitMeasure', async () => {
    ...
    expect(await unitMeasureDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.unitMeasure.delete.question');

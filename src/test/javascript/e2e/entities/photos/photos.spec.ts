...
describe('Photos e2e test', () => {
  ...
  it('should load Photos', async () => {
    ...
    expect(await photosComponentsPage.getTitle()).to.eq('epmresourcesApp.photos.home.title');
  });
  ...
  it('should load create Photos page', async () => {
    ...
    expect(await photosUpdatePage.getPageTitle()).to.eq('epmresourcesApp.photos.home.createOrEditLabel');
  ...
  it('should delete last Photos', async () => {
    ...
    expect(await photosDeleteDialog.getDialogTitle()).to.eq('epmresourcesApp.photos.delete.question');

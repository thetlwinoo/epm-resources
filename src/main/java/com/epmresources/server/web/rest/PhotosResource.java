...
import com.epmresources.server.service.dto.PhotosCriteria;
import com.epmresources.server.service.PhotosQueryService;
...
/**
 * REST controller for managing {@link com.epmresources.server.domain.Photos}.
 */
@RestController
@RequestMapping("/api")

...
/**
 * Criteria class for the {@link com.epmresources.server.domain.People} entity. This class is used
 * in {@link com.epmresources.server.web.rest.PeopleResource} to receive all the possible filtering options from

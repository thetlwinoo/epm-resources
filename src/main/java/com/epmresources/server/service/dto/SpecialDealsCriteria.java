...
/**
 * Criteria class for the {@link com.epmresources.server.domain.SpecialDeals} entity. This class is used
 * in {@link com.epmresources.server.web.rest.SpecialDealsResource} to receive all the possible filtering options from

...
/**
 * Criteria class for the {@link com.epmresources.server.domain.Suppliers} entity. This class is used
 * in {@link com.epmresources.server.web.rest.SuppliersResource} to receive all the possible filtering options from

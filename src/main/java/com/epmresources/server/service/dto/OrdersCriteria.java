...
/**
 * Criteria class for the {@link com.epmresources.server.domain.Orders} entity. This class is used
 * in {@link com.epmresources.server.web.rest.OrdersResource} to receive all the possible filtering options from

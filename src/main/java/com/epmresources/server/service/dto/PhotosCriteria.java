...
/**
 * Criteria class for the {@link com.epmresources.server.domain.Photos} entity. This class is used
 * in {@link com.epmresources.server.web.rest.PhotosResource} to receive all the possible filtering options from

...
/**
 * Criteria class for the {@link com.epmresources.server.domain.PurchaseOrders} entity. This class is used
 * in {@link com.epmresources.server.web.rest.PurchaseOrdersResource} to receive all the possible filtering options from

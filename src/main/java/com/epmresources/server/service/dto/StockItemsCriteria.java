...
/**
 * Criteria class for the {@link com.epmresources.server.domain.StockItems} entity. This class is used
 * in {@link com.epmresources.server.web.rest.StockItemsResource} to receive all the possible filtering options from

...
/**
 * Criteria class for the {@link com.epmresources.server.domain.VehicleTemperatures} entity. This class is used
 * in {@link com.epmresources.server.web.rest.VehicleTemperaturesResource} to receive all the possible filtering options from

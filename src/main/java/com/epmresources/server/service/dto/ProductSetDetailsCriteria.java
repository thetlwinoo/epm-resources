...
/**
 * Criteria class for the {@link com.epmresources.server.domain.ProductSetDetails} entity. This class is used
 * in {@link com.epmresources.server.web.rest.ProductSetDetailsResource} to receive all the possible filtering options from

...
/**
 * Criteria class for the {@link com.epmresources.server.domain.ProductDocument} entity. This class is used
 * in {@link com.epmresources.server.web.rest.ProductDocumentResource} to receive all the possible filtering options from

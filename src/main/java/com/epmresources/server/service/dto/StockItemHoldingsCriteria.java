...
/**
 * Criteria class for the {@link com.epmresources.server.domain.StockItemHoldings} entity. This class is used
 * in {@link com.epmresources.server.web.rest.StockItemHoldingsResource} to receive all the possible filtering options from

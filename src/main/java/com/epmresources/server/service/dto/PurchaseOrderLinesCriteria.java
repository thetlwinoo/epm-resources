...
/**
 * Criteria class for the {@link com.epmresources.server.domain.PurchaseOrderLines} entity. This class is used
 * in {@link com.epmresources.server.web.rest.PurchaseOrderLinesResource} to receive all the possible filtering options from

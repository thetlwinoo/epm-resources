...
/**
 * Criteria class for the {@link com.epmresources.server.domain.ProductChoice} entity. This class is used
 * in {@link com.epmresources.server.web.rest.ProductChoiceResource} to receive all the possible filtering options from

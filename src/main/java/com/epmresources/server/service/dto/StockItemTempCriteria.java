...
/**
 * Criteria class for the {@link com.epmresources.server.domain.StockItemTemp} entity. This class is used
 * in {@link com.epmresources.server.web.rest.StockItemTempResource} to receive all the possible filtering options from
